                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">Rp</span>
                                    <input type="number" x-model="formData.selling_price" @blur="validateField('selling_price')"
                                        class="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                        :class="errors.selling_price ? 'border-red-500' : 'border-gray-300'" placeholder="0">
                                </div>
                                <p x-show="errors.selling_price" class="mt-1 text-sm text-red-500" x-text="errors.selling_price"></p>
                            </div>
            ...
            return {
                ...
                validateField(field) {
                    ...
                    switch (field) {
                        ...
                        case 'selling_price':
                            if (!this.formData.selling_price) {
                                this.errors.selling_price = 'Harga jual wajib diisi';
                            }
                            break;
