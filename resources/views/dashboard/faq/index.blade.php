...
@section('content')
<div x-data="faqPage()" class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- Header -->
        <div class="text-center mb-10">
            <h1 class="text-4xl font-bold text-gray-900 mb-3">Seller FAQ</h1>
            <p class="text-lg text-gray-600">Everything you need to know about selling on our platform</p>
        </div>
        ...
        <div class="mb-8">
            <div class="relative">
                <input 
                    ...
                    class="w-full px-5 py-4 pl-12 text-lg border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                >
        ...
        <div x-show="searchQuery && filteredFaqs.length === 0" class="text-center py-12">
            ...
            <button @click="searchQuery = ''; filterFaqs()" class="mt-4 text-blue-600 hover:text-blue-700 font-medium">
                Clear search
            </button>
        </div>
        ...
        <!-- Still Need Help -->
        <!-- <div class="mt-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-8 text-center">
            <h3 class="text-2xl font-bold text-white mb-3">Still need help?</h3>
            <p class="text-blue-100 mb-6">Can't find the answer you're looking for? Contact our support team.</p>
            <a href="{{ route('dashboard') }}" class="inline-block px-6 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-colors">
                Go to Dashboard
            </a>
        </div> -->
